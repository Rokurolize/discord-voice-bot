...
class Config:
    ...
    def from_env(cls) -> "Config":
        ...
        return cls(
            ...
            target_guild_id=int(os.environ.get("TARGET_GUILD_ID", "0")),
            target_voice_channel_id=int(os.environ.get("TARGET_VOICE_CHANNEL_ID", "0")),
            ...
            message_queue_size=int(os.environ.get("MESSAGE_QUEUE_SIZE", "10")),
            ...
            enable_self_message_processing=os.environ.get("ENABLE_SELF_MESSAGE_PROCESSING", "false").lower() == "true",
        )
